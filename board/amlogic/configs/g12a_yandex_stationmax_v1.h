...
#ifndef __G12A_YANDEX_STATIONMAX_V1_H__
#define __G12A_YANDEX_STATIONMAX_V1_H__
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read deviceid ${loadaddr} str; then "\
                    "setenv bootargs ${bootargs} androidboot.serialno=${deviceid} androidboot.deviceid=${deviceid};"\
                    "setenv serial ${deviceid};"\
                "else "\
...
#define CONFIG_DEVICE_PRODUCT	"yandex_stationmax"
